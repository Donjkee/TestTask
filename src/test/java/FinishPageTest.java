...
public class FinishPageTest
{
    ...
    @Test
    public void testIsConfirmationMessageAppeared()
    {
        ...
        assertTrue(finishPage.isConfirmationMessageAppeared(message));
    }

    @Test
    public void testIsCompleteTextAppeared()
    {
        ...
        assertTrue(finishPage.isCompleteTextAppeared(message));
    }
}
